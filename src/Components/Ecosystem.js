...
const EcoSystem = () => {
    return(
        <div className="w-full pt-10 lg:py-60" style={{ backgroundImage: `url(${bg3})` , backgroundRepeat: "no-repeat", backgroundSize: "2000px 504px"}}>
            <div className="flex justify-center items-center flex-col">
                <div className="">
                    <h1 className="text-white text-center mx-0.5 text-3xl lg:text-5xl">MONT нь үнийн савалгаагүй.</h1>
                </div>
