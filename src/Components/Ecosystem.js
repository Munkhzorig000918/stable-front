        ...
        <div id="service" className="w-full pt-10 pb-10 lg:py-40" style={{ backgroundImage: `url(${bg3})` , backgroundRepeat: "no-repeat", backgroundSize: "2000px 504px"}}>
            <div className="flex justify-center items-center flex-col">
                ...
                <div className="lg:w-4/6">
                    <p className="text-white text-center text-sm font-normal lg:text-2xl mt-20 mx-2">MONT нь Монгол төгрөгт аргамжсан стэйблкойн учир крипто зах зээлийн хэлбэлзлээс ангид байна. Энэхүү үнийн харьцангуй тогтвортой байдал нь ханшаас үүсэх эрсдэлийг бууруулах болно.</p>
                </div> 
            </div>
        </div>
    )
