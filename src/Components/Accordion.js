        ...
        <Disclosure as="div" className="mt-2">
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 pt-4 pb-2 text-md text-gray-700">
                 Та MONT-ыг өөрийн үйлчлүүлдэг бирж эсвэл хэтэвчээр дамжуулан шилжүүлэх боломжтой. Та шилжүүлэг хийхээсээ өмнө зөв сүлжээг (BEP-20, ERC-20, г.м) ашиглажбайгаагаа дахин нягтлаарай.
              </Disclosure.Panel>
            </>
          )}
        </Disclosure>
